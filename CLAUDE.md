...
## Always Do First
- **Invoke the `frontend-design` and `ui-ux-pro-max` skill** before writing any frontend code, every session, no exceptions.
...
## Screenshot Workflow
- Puppeteer is installed at `C:/Users/Hamza/AppData/Local/Temp/puppeteer-test/`. Chrome cache is at `C:/Users/Hamza/.cache/puppeteer/`.
...
## Deployment Verification (Backend / Live Render Fixes)

For any backend code change, the verification protocol is:
...
**Never mark a backend fix as verified using only localhost.** The live Render environment has different env vars and cold-start behaviour.
